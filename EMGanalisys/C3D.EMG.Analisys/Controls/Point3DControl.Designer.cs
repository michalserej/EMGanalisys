namespace C3D.EMG.Analisys.Controls
{
    partial class Point3DControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.gestureHandler1 = new C3D.EMG.Analisys.Gesture.MouseGestureHandler();
            this.gestureHandler2 = new C3D.EMG.Analisys.Gesture.MouseGestureHandler();
            this.gestureHandler3 = new C3D.EMG.Analisys.Gesture.MouseGestureHandler();
            this.gestureHandler4 = new C3D.EMG.Analisys.Gesture.MouseGestureHandler();
            ...
            this.gestureHandler1.OnMouseGestureToLeft += new C3D.EMG.Analisys.Gesture.MouseGestureToLeft(this.gesturehandler_OnMouseGestureToLeftOrRight);
            this.gestureHandler1.OnMouseGestureToRight += new C3D.EMG.Analisys.Gesture.MouseGestureToRight(this.gesturehandler_OnMouseGestureToLeftOrRight);
            this.gestureHandler1.OnMouseGestureToTop += new C3D.EMG.Analisys.Gesture.MouseGestureToTop(this.gesturehandler_OnMouseGestureToTopOrBottom);
            this.gestureHandler1.OnMouseGestureToBottom += new C3D.EMG.Analisys.Gesture.MouseGestureToBottom(this.gesturehandler_OnMouseGestureToTopOrBottom);
            ...
            this.gestureHandler2.OnMouseGestureToLeft += new C3D.EMG.Analisys.Gesture.MouseGestureToLeft(this.gesturehandler_OnMouseGestureToLeftOrRight);
            this.gestureHandler2.OnMouseGestureToRight += new C3D.EMG.Analisys.Gesture.MouseGestureToRight(this.gesturehandler_OnMouseGestureToLeftOrRight);
            this.gestureHandler2.OnMouseGestureToTop += new C3D.EMG.Analisys.Gesture.MouseGestureToTop(this.gesturehandler_OnMouseGestureToTopOrBottom);
            this.gestureHandler2.OnMouseGestureToBottom += new C3D.EMG.Analisys.Gesture.MouseGestureToBottom(this.gesturehandler_OnMouseGestureToTopOrBottom);
            ...
            this.gestureHandler3.OnMouseGestureToLeft += new C3D.EMG.Analisys.Gesture.MouseGestureToLeft(this.gesturehandler_OnMouseGestureToLeftOrRight);
            this.gestureHandler3.OnMouseGestureToRight += new C3D.EMG.Analisys.Gesture.MouseGestureToRight(this.gesturehandler_OnMouseGestureToLeftOrRight);
            this.gestureHandler3.OnMouseGestureToTop += new C3D.EMG.Analisys.Gesture.MouseGestureToTop(this.gesturehandler_OnMouseGestureToTopOrBottom);
            this.gestureHandler3.OnMouseGestureToBottom += new C3D.EMG.Analisys.Gesture.MouseGestureToBottom(this.gesturehandler_OnMouseGestureToTopOrBottom);
            ...
            this.gestureHandler4.OnMouseGestureToLeft += new C3D.EMG.Analisys.Gesture.MouseGestureToLeft(this.gesturehandler_OnMouseGestureToLeftOrRight);
            this.gestureHandler4.OnMouseGestureToRight += new C3D.EMG.Analisys.Gesture.MouseGestureToRight(this.gesturehandler_OnMouseGestureToLeftOrRight);
            this.gestureHandler4.OnMouseGestureToTop += new C3D.EMG.Analisys.Gesture.MouseGestureToTop(this.gesturehandler_OnMouseGestureToTopOrBottom);
            this.gestureHandler4.OnMouseGestureToBottom += new C3D.EMG.Analisys.Gesture.MouseGestureToBottom(this.gesturehandler_OnMouseGestureToTopOrBottom);
